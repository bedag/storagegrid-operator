...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "2fb9596b.bedag.ch",
	...
	if err := mgr.GetFieldIndexer().IndexField(context.TODO(), &s3v1alpha1.S3TenantAccount{}, "status.s3ApiEndpoint.s3TenantClassName", func(rawObj client.Object) []string {
		s3Tenant := rawObj.(*s3v1alpha1.S3TenantAccount)
		return []string{s3Tenant.Spec.S3TenantClassName}
	}); err != nil {
	...
	if operatorNamespace == "" {
		setupLog.Error(nil, fmt.Sprintf("OPERATOR_NAMESPACE environment variable is not set, deafulting to %s", defaultOperatorNamespace))
